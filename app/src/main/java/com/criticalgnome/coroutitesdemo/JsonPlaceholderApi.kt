...
interface JsonPlaceholderApi {
    ...
    @GET("/todos")
    fun getTodos(): Deferred<Response<List<Todo>>>
    ...
    @GET("/posts/{id}")
    fun getPost(@Path("id") id: Long): Deferred<Response<Post>>

    @GET("/comments/{id}")
    fun getComment(@Path("id") id: Long): Deferred<Response<Comment>>

    @GET("/albums/{id}")
    fun getAlbum(@Path("id") id: Long): Deferred<Response<Album>>

    @GET("/photos/{id}")
    fun getPhoto(@Path("id") id: Long): Deferred<Response<Photo>>

    @GET("/todos/{id}")
    fun getTodo(@Path("id") id: Long): Deferred<Response<Todo>>
